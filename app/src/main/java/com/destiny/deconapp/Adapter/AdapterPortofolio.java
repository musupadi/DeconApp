...
public class AdapterPortofolio extends RecyclerView.Adapter<AdapterPortofolio.CardViewViewHolder>{
    ...
    public AdapterPortofolio(Context context) {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_portofolio, viewGroup, false);
